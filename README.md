GPBAT [![Build Status](https://travis-ci.org/poutsjr/jhipster-gpbat.svg?branch=master)](https://travis-ci.org/poutsjr/jhipster-gpbat)
===========
...
To optimize the gpbat application for production, run:
